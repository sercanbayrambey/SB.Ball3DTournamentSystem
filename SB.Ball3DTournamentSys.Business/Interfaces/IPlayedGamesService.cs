...
namespace SB.Ball3DTournamentSys.Business.Interfaces
{
    public interface IPlayedGamesService : IGenericService<PlayedGamesEntity>
    {
        ...
        /// <summary>
        /// Edits the scores, change match state to played, make match state confirmed by sender and returns the winner team.
        /// </summary>
        /// <param name="playedGameToBeEdited"></param>
        /// <param name="homeTeamScore"></param>
        /// <param name="awayTeamScore"></param>
        ...
        /// <returns></returns>
        TeamEntity UpdateScore(PlayedGamesEntity playedGameToBeEdited, int homeTeamScore, int awayTeamScore, int senderUserId);
        ...
        void AddWinnerToNextGame(PlayedGamesEntity playedGame, TeamEntity winnerTeam);
    }
}
