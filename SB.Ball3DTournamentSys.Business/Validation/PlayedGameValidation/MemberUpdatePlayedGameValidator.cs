...
{
    public class MemberUpdatePlayedGameValidator : AbstractValidator<MemberUpdatePlayedGameDto>
    {
        public MemberUpdatePlayedGameValidator()
        {
        ...
        private bool GameIsDraw(MemberUpdatePlayedGameDto model)
        {
