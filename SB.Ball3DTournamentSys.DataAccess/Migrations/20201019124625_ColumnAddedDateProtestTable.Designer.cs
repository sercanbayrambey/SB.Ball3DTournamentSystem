...
namespace SB.Ball3DTournamentSys.DataAccess.Migrations
{
    ...
    [Migration("20201019124625_ColumnAddedDateProtestTable")]
    partial class ColumnAddedDateProtestTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SB.Ball3DTournamentSys.Entities.Concrete.PlayedGamesEntity", b =>
                {
                    ...
                    b.Property<bool>("IsAwayTeamConfirmedResult")
                        .HasColumnType("bit");

                    b.Property<bool>("IsFinished")
                        .HasColumnType("bit");

                    b.Property<bool>("IsHomeTeamConfirmedResult")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("SB.Ball3DTournamentSys.Entities.Concrete.ProtestEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SB.Ball3DTournamentSys.Entities.Concrete.ProtestResponseEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SB.Ball3DTournamentSys.Entities.Concrete.TournamentBracketRoundEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("TournamentBracketRounds");
                });
            ...
            modelBuilder.Entity("SB.Ball3DTournamentSys.Entities.Concrete.ProtestEntity", b =>
                {
                    ...
                    b.HasOne("SB.Ball3DTournamentSys.Entities.Concrete.PlayedGamesEntity", "PlayedGame")
                        .WithMany("Protests")
